...
<body>
    ...
    <div class="banner">
        <div class="container">
            <h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> CAR E-Booking System </h1>
        </div>
    </div>
                ...
                foreach ($results as $result) {    ?>
                    <div class="rom-btm">
                        ...
                        <div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
                            <h5>JD <?php echo htmlentities($result->PackagePrice); ?></h5>
    ...
    <div class="routes">
        <div class="container">
            <div class="col-md-4 routes-left wow fadeInRight animated" data-wow-delay=".5s">
                <div class="rou-left">
                    <a href="#"><i class="fa fa-list-alt fa-5x" aria-hidden="true"></i></a>
                </div>
